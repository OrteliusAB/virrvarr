  ...
  function () {
    ...
    _createClass(DOMProcessor, [{
      ...
      value: function drawNodeCollapsedEdgeCounter(element, data) {
        ...
        element.append("g").attr("id", "badge-" + data.id + "-hidden-edge-counter").attr("style", "pointer-events:none;").attr("transform", "translate(".concat(translateX, " ").concat(translateY, ")")).append("path").attr("d", rightTopRoundedRect(-(rectWidth / 2), -(rectHeight / 2), rectWidth, rectHeight, 10)).attr("class", "virrvarr-node-badge").select(function () {
          return this.parentNode;
      ...
      value: function drawPin(element, data) {
        ...
        element.append("g").attr("id", "pin-" + data.id).attr("style", "pointer-events:none;").attr("transform", "translate(".concat(translateX - rectWidth / 2, " ").concat(translateY, ")")).append("path").attr("d", rightBottomRoundedRect(-(rectWidth / 2), -(rectHeight / 2), rectWidth, rectHeight, 10)).attr("class", "virrvarr-node-badge").select(function () {
          return this.parentNode;
