...
(function (global, factory) {
  ...
  function () {
    ...
    function EntityProcessor(eventEmitter, datastore) {
      ...
      this.ee.on(EVENTS.LASSO_MOVED, function (x, y, width, height) {
        return _this.selectLassoArea(x, y, width, height);
      });
  ...
  function () {
    ...
    _createClass(VVNode, [{
      key: "updateData",
      value: function updateData(type, name, icon, data) {
        this.type = type;
        this.name = name;
        this.icon = icon;
        this.data = data;
    ...
    _createClass(Datastore, [{
      ...
      value: function updateDataset(newNodes, newEdges) {
        ...
        this.allNodes = newNodes.map(function (node) {
          var existingNode = _this3.allNodes.find(function (oldNode) {
      ...
      value: function applyFilters() {
        ...
        this.allNodes.forEach(function (node) {
          ...
          _this4.filters.nodes.forEach(function (filter) {
            if (!isFiltered) {
        ...
        this.allEdges.forEach(function (edge) {
          ...
          _this4.filters.edges.forEach(function (filter) {
            if (!isFiltered) {
              if (filter.filterFunction) {
          ...
          var foundSource = _this4.allNodes.find(function (node) {
            return edge.sourceNode === node.id && !node.isFiltered;
          });

          var foundTarget = _this4.allNodes.find(function (node) {
      ...
      value: function stageNodePositions(rootX, rootY, targetX, targetY) {
        ...
        if (targetX && !rootX) {
          var nodes = this.allNodes.filter(function (node) {
            return !_this5.isNodeLive(node) && _this5.liveNodes.find(function (onScreenNode) {
          ...
          _nodes.forEach(function (node) {
            var connectedNodes = _this5.allEdges.filter(function (edge) {
              return (edge.targetNode === node.id || edge.sourceNode === node.id) && edge.targetNode !== edge.sourceNode;
            }).map(function (edge) {
              return edge.sourceNode === node.id ? {
                node: _this5.getNodeByID(edge.targetNode),
                edgeDistance: edge.edgeDistance
              } : {
                node: _this5.getNodeByID(edge.sourceNode),
                edgeDistance: edge.edgeDistance
              };
            }).filter(function (connectedNode) {
              return _this5.liveNodes.includes(connectedNode.node);
      ...
      value: function updateLiveData() {
        ...
        this.liveNodes = this.allNodes.filter(function (node) {
          return _this6.isNodeLive(node);
        });
        this.liveEdges = this.allEdges.filter(function (edge) {
          return _this6.isEdgeLive(edge);
        });
      ...
      value: function updateNumberOfHiddenEdgesOnNodes() {
        ...
        this.allNodes.forEach(function (node) {
          ...
          node.hiddenEdgeCount = _this7.allEdges.filter(function (edge) {
      ...
      value: function implodeOrExplodeNode(rootNodeID, isImplode) {
        ...
        var collateralEdges = this.allEdges.filter(function (edge) {
          if (connectedNodes.includes(edge.sourceNode) && connectedNodes.includes(edge.targetNode)) {
            ...
            //Going outwards
            return _this8.isNodeLive(_this8.getNodeByID(edge.targetNode));
          } else if (connectedNodes.includes(edge.targetNode)) {
            //Going inwards
            return _this8.isNodeLive(_this8.getNodeByID(edge.sourceNode));
          } else {
            return false;
          }
        });
      ...
      value: function implodeOrExplodeNodeLeafs(rootNodeID, isImplode) {
        ...
        var connectedEdges = this.allEdges.filter(function (edge) {
          ...
          return !_this9.allEdges.find(function (secondaryEdge) {
        ...
        var edges = [].concat(_toConsumableArray(connectedEdges), _toConsumableArray(collateralEdges));
        var nodes = connectedNodes.map(function (nodeID) {
          return _this9.getNodeByID(nodeID);
        });
        this.setNodesAndEdgesHiddenStatus(nodes, edges, isImplode);
        return {
          updatedNodes: nodes,
      ...
      value: function implodeOrExplodeNodeRecursive(nodeID, isImplode) {
        ...
        if (!processedNodeIDs.includes(nodeID)) {
          ...
          updatedNodes.forEach(function (node) {
            return _this10.implodeOrExplodeNodeRecursive(node.id, isImplode, processedNodeIDs);
          });
        }
      }
      /**
      ...
      value: function implodeOrExplodeNodeNonCircular(rootNodeID, isImplode) {
        ...
        var connectedEdges = this.allEdges.filter(function (edge) {
          ...
          return _this11.calculateEdgePathFromNodeToNode(edge.targetNode, rootNodeID).length === 0;
        });
        var connectedNodes = connectedEdges.map(function (edge) {
          return edge.targetNode;
        });
        ...
        connectedNodes.forEach(function (nodeID) {
          return _this11.implodeOrExplodeNodeRecursive(nodeID, isImplode);
        });
      }
      /**
      ...
      value: function calculateEdgePathFromNodeToNode(nodeIDFrom, nodeIDTo) {
        ...
        if (!crossedNodes.includes(nodeIDFrom)) {
          ...
          nextSteps.forEach(function (node) {
            ...
            var potentialPath = _this12.calculateEdgePathFromNodeToNode(node, nodeIDTo, pathCopy, crossedNodes);
    ...
    _createClass(ContextMenu, [{
      ...
      value: function createContextMenu(clickedItem, contextSectionsArray, customSectionsArray, mouseX, mouseY) {
        ...
        if (this.enableBuiltinContextMenu) {
          contextSectionsArray.forEach(function (section) {
            _this2.processSection(ulElement, section, previousSectionWasSeen, clickedItem, direction);
      ...
      value: function processSection(ul, section, shouldAddSeparatorBefore, clickedItem) {
        ...
        section.forEach(function (menuItem) {
          var mainContainer = ul.append("li").append("div").attr("class", "virrvarr-context-menu-option").on("click", function () {
          ...
          mainContainer.append("div").attr("class", "virrvarr-context-menu-option-title").text(function () {
  ...
  function () {
    ...
    _createClass(Grid, [{
      ...
      value: function initializeGrid() {
        ...
        var grid = select(this.graphContainerElement).select("svg").insert("rect", ":first-child").attr("width", "100%").attr("height", "100%").attr("fill", "url(#grid)").attr("class", "grid");
    ...
    _createClass(DOMProcessor, [{
      ...
      value: function updateMarkers(edges) {
        ...
        edges.forEach(function (l) {
          _this3.drawMarker(defs, l, false);

          if (l.nameFrom) {
            _this3.drawMarker(defs, l, true);
          }
        });
      }
      /**
      ...
      value: function updateNodes(nodes) {
        ...
        .on("start", function (d) {
          ...
          for (var i = 0; i < _this6.dragSelection.length; i++) {
            if (!_this6.pinMode) {
              _this6.dragSelection[i].unPin();
            }

            _this6.updateNodes(_this6.nodes);

            _this6.ee.trigger(EVENTS.NODE_DRAG_ENDED, _this6.dragSelection[i]);
          }
          ...
          _this6.drawNode(element, d);
        }); //Draw counter badges for imploded edges

        nodes.forEach(function (node) {
          _this6.rootG.select("[id='badge-".concat(node.id, "-hidden-edge-counter']")).remove();

          if (node.hiddenEdgeCount) {
            var element = _this6.rootG.select("[id='".concat(node.id, "']")).select(function () {
              return this.parentNode;
            });

            _this6.drawNodeCollapsedEdgeCounter(element, node);
          }
        }); //Draw pin badge for fixated nodes

        nodes.forEach(function (node) {
          _this6.rootG.select("[id='pin-".concat(node.id, "']")).remove();
      ...
      value: function labelMouseEnter(edgeData, direction) {
        ...
        setTimeout(function () {
          ...
          if (marker._groups[0].length > 0 && marker.classed("hovered")) {
            ...
            _this9.rootG.selectAll(".label").sort(function (a, b) {
      ...
      value: function drawMultiplicity(edge, direction) {
        ...
        var card = edge.append("g").attr("class", function (l) {
          return _this10.getMarkerId(l, direction === "to");
      ...
      value: function drawNode(element, data) {
        ...
        switch (data.shape) {
          ...
          case "layeredCircle":
            element.insert("circle", "g").attr("r", function (d) {
              return d.radius;
            }).attr("style", "stroke-width:2;fill:#fff;stroke:#000;stroke-dasharray:0;pointer-events:none;").attr("id", data.id).attr("class", "layered-circle");
            element.insert("circle", "g").attr("r", function (d) {
              return d.radius - 4;
        ...
        element.on("mouseenter", function (d) {
          _this11.handleHoverEvent(d, "enter");
        }).on("mouseleave", function (d) {
          _this11.handleHoverEvent(d, "leave");
        }).on("mousemove", function (d) {
          _this11.ee.trigger(EVENTS.MOUSE_OVER_NODE, d);
        }).on("mouseout", function (d) {
          _this11.ee.trigger(EVENTS.MOUSE_LEFT_NODE, d);
        });
      ...
      value: function attachEntityClickListeners() {
        ...
        this.rootG.selectAll(".node").on("click", function (d) {
          ...
          timeout = setTimeout(function () {
            _this12.ee.trigger(EVENTS.CLICK_ENTITY, {
              id: d.id,
              data: d.data
            });
          ...
          _this12.ee.trigger(EVENTS.DBL_CLICK_ENTITY, {
            id: d.id,
            data: d.data
          });
          ...
          _this12.ee.trigger(EVENTS.RIGHT_CLICK_ENTITY, d);
        });
        this.rootG.selectAll(".label .from").on("click", function (d) {
          ...
          _this12.ee.trigger(EVENTS.RIGHT_CLICK_ENTITY, d, "from");
        });
        this.rootG.selectAll(".label .to").on("click", function (d) {
          ...
          _this12.ee.trigger(EVENTS.RIGHT_CLICK_ENTITY, d, "to");
        });
      }
      /**
      ...
      value: function tick() {
        ...
        this.edgePath.attr("d", function (l) {
          ...
          var lineTypeToUse = l.lineType ? l.lineType : _this13.lineType; //Taxi lines
          ...
          if (lineTypeToUse === "cubicbezier" && l.multiEdgeCount === 1) {
            ...
            return "M".concat(pathStart.x, ", ").concat(pathStart.y, " \n\t\t\t\t\tC").concat((pathStart.x + pathEnd.x) / 2, ", ").concat(pathStart.y, " \n\t\t\t\t\t").concat((pathStart.x + pathEnd.x) / 2, ", ").concat(pathEnd.y, " \n\t\t\t\t\t").concat(pathEnd.x, ", ").concat(pathEnd.y);
              ...
              l.curvePoint = MathUtil.calculateCurvePoint(pathStart, pathEnd, l);
              return MathUtil.curveFunction([MathUtil.calculateIntersection(l.curvePoint, l.source, 1), l.curvePoint, MathUtil.calculateIntersection(l.curvePoint, l.target, 1)]);
            }
        }); //Multiplicities
        ...
        this.activeMultiplicities.attr("transform", function (l) {
          ...
          var n = MathUtil.calculateNormalizedVector(l.curvePoint, l.source, Env.MULTIPLICITY_VDISTANCE);
        ...
        this.labels.attr("transform", function (l) {
          ...
          d["label".concat(direction, "RelativeX")] = d.relativeX = rect.getBoundingClientRect().x;
          d["label".concat(direction, "RelativeY")] = d.relativeY = rect.getBoundingClientRect().y;
          d["label".concat(direction, "RelativeWidth")] = d.relativeWidth = rect.getBoundingClientRect().width;
          d["label".concat(direction, "RelativeHeight")] = d.relativeHeight = rect.getBoundingClientRect().height;
        });
      }
    }]);
