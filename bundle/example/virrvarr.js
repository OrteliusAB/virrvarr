...
(function (global, factory) {
  ...
  var VVEdge = function VVEdge(id, type, sourceNode, targetNode, nameFrom, nameTo, multiplicityFrom, multiplicityTo, data) {
  ...
  function () {
    ...
    _createClass(Datastore, [{
      ...
      key: "updateNodeIDs",
      value: function updateNodeIDs() {
        this.allNodes.forEach(function (node, nodeIndex) {
  ...
  function () {
    ...
    _createClass(DOMProcessor, [{
      ...
      value: function updateNodes(nodes) {
        ...
        nodes.forEach(function (node) {
          _this5.rootG.select("[id='badge-".concat(node.id, "-hidden-edge-counter']")).remove();

          if (node.hiddenEdgeCount) {
            var element = _this5.rootG.select("[id='".concat(node.id, "']")).select(function () {
              return this.parentNode;
            });
        ...
        nodes.forEach(function (node) {
          _this5.rootG.select("[id='pin-".concat(node.id, "']")).remove();
      ...
      value: function labelMouseEnter(edgeData, direction) {
        ...
        setTimeout(function () {
          var marker = _this8.rootG.selectAll("marker#" + _this8.getMarkerId(edgeData, inverse)).select("path");
  ...
  function () {
    ...
    _createClass(SelectionLasso, [{
      ...
      value: function moveLasso() {
        ...
        var newX = coordinates[0] + this.graphContainerElement.getBoundingClientRect().x - window.pageXOffset;
        var newY = coordinates[1] + this.graphContainerElement.getBoundingClientRect().y - window.pageYOffset;
  ...
  function () {
    function Engine(forceCenterX, forceCenterY, eventEmitter) {
      ...
      this.ee.on(EVENTS.LASSO_MODE_TOGGLED, function () {
        _this.alpha(0.001);
